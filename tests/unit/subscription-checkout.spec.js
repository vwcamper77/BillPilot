...
test("subscription Checkout uses the configured recurring Price and seven-day trial", () => {
  const params = buildSubscriptionCheckoutParams({ uid: "uid_1", email: "member@example.com", priceId: "price_monthly_test", origin: "https://example.com" });
