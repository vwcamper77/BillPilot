    ...
    content: [
      ...
      { type: "formula", label: "Working amount before the next income date", formula: "usable balances + confirmed earlier income − bills − committed costs − optional buffer" },
      {
        ...
        segments: [
          ...
          { text: "payday cashflow calculator", href: "/tools/payday-cashflow-calculator" },
          { text: ". It subtracts bills you add, shows the net cash left per day and plots a dated runway to payday." },
        ],
      },
...
export const JOURNAL_TOOLS = [
  {
    ...
    description: "Subtract upcoming bills, see the net cash left per day and view a dated runway to payday. No bank connection, account or sign-up required.",
    label: "Free tool",
