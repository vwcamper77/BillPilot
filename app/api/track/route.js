...
export async function POST(request) {
  try {
    ...
    await recordAnalyticsEvent({
      ...
      experiment_id: sanitizeString(body?.experiment_id, 128),
      content_id: sanitizeString(body?.content_id, 128),
      creative_id: sanitizeString(body?.creative_id, 128),
      landing_variant: sanitizeString(body?.landing_variant, 128),
      access_type: sanitizeString(body?.access_type, 128),
...
function sanitizeAttribution(attribution) {
  ...
  return {
    ...
    experiment_id: sanitizeString(attribution.experiment_id, 128),
    content_id: sanitizeString(attribution.content_id, 128),
    creative_id: sanitizeString(attribution.creative_id, 128),
    landing_variant: sanitizeString(attribution.landing_variant, 128),
    access_type: sanitizeString(attribution.access_type, 128),
