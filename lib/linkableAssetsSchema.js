...
import { createGmbfOrganizationSchema } from "./productFamily.js";
...
export const PAYDAY_CALCULATOR_DESCRIPTION = "Subtract bills due before payday, see the net cash left per day and view a dated cash runway. Free UK calculator with no bank connection or sign-up.";
...
export function createPaydayCalculatorSchemas() {
  return {
    ...
    application: {
      ...
      brand: { "@type": "Brand", name: "ClearTill", url: HOME_URL },
      provider: createGmbfOrganizationSchema(),
    },
  };
}
