 ...
 */
export function buildFourWeekCashflowWaterfall(todayIso, paydayDate, currentBalance, bills = [], largeCosts = [], incomeAmount = 0) {
  ...
  return weekBuckets.map((bucket, index) => {
    ...
    const incomeReceived = bucket.containsPayDate ? safeIncomeAmount : 0;
