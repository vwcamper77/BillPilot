  ...
  const response = await fetchImpl(OPENAI_RESPONSES_URL, {
    ...
    body: JSON.stringify({
      ...
      input: [
        ...
        {
          role: "user",
          content: `Scheduled date: ${dateKey}. Topic: ${topic}. Produce exactly one complete article draft with its claims, sources, and hero alt text.`,
        },
      ],
      text: {
        format: {
...
export { HERO_TITLE_SCHEMA, HERO_VISION_SCHEMA, topicForDate };
