...
// incomeEvents/{eventId} — optional dated income amount and label.
export const INCOME_EVENT_SENSITIVE_FIELDS = ["amount", "name"];
...
export const LARGE_COST_SENSITIVE_FIELDS = [
  "amount",
  "amountAlreadySaved",
...
export const SENSITIVE_FIELDS_BY_TYPE = {
  ...
  incomeEvent: INCOME_EVENT_SENSITIVE_FIELDS,
